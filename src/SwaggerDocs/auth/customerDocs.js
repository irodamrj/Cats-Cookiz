    ...
    paths: {
      '/api/auth/customer/google': {
        get: {
          ...
          description: 'Redirects the customer to the Google authentication page for sign-in',
          responses: {
            '302': {
      ...
      '/api/auth/customer/google/callback': {
        get: {
          ...
          description: 'Callback route for handling the Google authentication response',
          responses: {
            '302': {
      ...
      '/api/auth/customer/facebook': {
        get: {
          ...
          description: 'Redirects the customer to the Facebook authentication page for sign-in',
          responses: {
            '302': {
      ...
      '/api/auth/customer/facebook/callback': {
        get: {
          ...
          description: 'Callback route for handling the Facebook authentication response',
          responses: {
            '302': {
      ...
      '/api/auth/customer/signup': {
        post: {
          ...
          responses: {
            ...
            '400': {
              description: 'Bad Request - Email already exists or invalid password',
            },
          },
        },
      },
